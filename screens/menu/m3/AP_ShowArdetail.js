                                                        ...
                                                        <>
                                                            <View>
                                                                <DataTable.Row>
                                                                    ...
                                                                    <DataTable.Cell >{currencyFormat(item.apd_A_mt)}</DataTable.Cell>
                                                                    <DataTable.Cell >{currencyFormat(item.sumpayment)}</DataTable.Cell>
                                                                    <DataTable.Cell >{currencyFormat((item.apd_A_mt + item.sumpayment))}</DataTable.Cell>
                                                                </DataTable.Row>
                                                            </View>
                                                        </>
                                                    )
