    ...
    const fetchInCome = async () => {
        ...
        await fetch(databaseReducer.Data.urlser + 'Executive', {
            ...
            .then((json) => {
                ...
                let responseData = JSON.parse(json.ResponseData);
                console.log(responseData.SHOWAPBALANCEBYAPKEY)
                                                        ...
                                                        <>
                                                            <View>
                                                                <DataTable.Row>
                                                                    ...
                                                                    <DataTable.Cell numeric>{currencyFormat(item.apd_A_mt)}</DataTable.Cell>
                                                                    <DataTable.Cell numeric>{currencyFormat(item.sumpayment)}</DataTable.Cell>
                                                                    <DataTable.Cell numeric>{currencyFormat((item.apd_A_mt + item.sumpayment))}</DataTable.Cell>
                                                                </DataTable.Row>
                                                            </View>
                                                        </>
                                                    )
