                                                        ...
                                                        <>
                                                            <View>
                                                                <DataTable.Row>
                                                                    ...
                                                                    <DataTable.Cell numeric>{safe_Format.currencyFormat(item.sumallpayment)}</DataTable.Cell>
                                                                    <DataTable.Cell numeric>{safe_Format.currencyFormat(item.sumnet)}</DataTable.Cell>
                                                                </DataTable.Row>
                                                            </View>
                                                        </>
                                                    )
